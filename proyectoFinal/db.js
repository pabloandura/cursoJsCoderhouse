...
const POLLO = [
{id: 'polloEntero', msFromEpoch: Date.parse('2016/04/01'), date:'2016/04/01', value: 34.990},
{id: 'polloEntero', msFromEpoch: Date.parse('2016/05/01'), date:'2016/05/01', value: 33.360},
{id: 'polloEntero', msFromEpoch: Date.parse('2016/06/01'), date:'2016/06/01', value: 33.230},
{id: 'polloEntero', msFromEpoch: Date.parse('2016/07/01'), date:'2016/07/01', value: 32.950},
{id: 'polloEntero', msFromEpoch: Date.parse('2016/08/01'), date:'2016/08/01', value: 34.390},
{id: 'polloEntero', msFromEpoch: Date.parse('2016/09/01'), date:'2016/09/01', value: 35.140},
{id: 'polloEntero', msFromEpoch: Date.parse('2016/10/01'), date:'2016/10/01', value: 36.140},
{id: 'polloEntero', msFromEpoch: Date.parse('2016/11/01'), date:'2016/11/01', value: 35.850},
{id: 'polloEntero', msFromEpoch: Date.parse('2016/12/01'), date:'2016/12/01', value: 37.290},
{id: 'polloEntero', msFromEpoch: Date.parse('2017/01/01'), date:'2017/01/01', value: 34.880},
{id: 'polloEntero', msFromEpoch: Date.parse('2017/02/01'), date:'2017/02/01', value: 34.730},
{id: 'polloEntero', msFromEpoch: Date.parse('2017/03/01'), date:'2017/03/01', value: 38.490},
{id: 'polloEntero', msFromEpoch: Date.parse('2017/04/01'), date:'2017/04/01', value: 37.130},
{id: 'polloEntero', msFromEpoch: Date.parse('2017/05/01'), date:'2017/05/01', value: 35.610},
{id: 'polloEntero', msFromEpoch: Date.parse('2017/06/01'), date:'2017/06/01', value: 34.450},
{id: 'polloEntero', msFromEpoch: Date.parse('2017/07/01'), date:'2017/07/01', value: 35.510},
{id: 'polloEntero', msFromEpoch: Date.parse('2017/08/01'), date:'2017/08/01', value: 36.210},
{id: 'polloEntero', msFromEpoch: Date.parse('2017/09/01'), date:'2017/09/01', value: 38.570},
{id: 'polloEntero', msFromEpoch: Date.parse('2017/10/01'), date:'2017/10/01', value: 39.300},
{id: 'polloEntero', msFromEpoch: Date.parse('2017/11/01'), date:'2017/11/01', value: 38.190},
{id: 'polloEntero', msFromEpoch: Date.parse('2017/12/01'), date:'2017/12/01', value: 39.630},
{id: 'polloEntero', msFromEpoch: Date.parse('2018/01/01'), date:'2018/01/01', value: 41.780},
{id: 'polloEntero', msFromEpoch: Date.parse('2018/02/01'), date:'2018/02/01', value: 45.320},
{id: 'polloEntero', msFromEpoch: Date.parse('2018/03/01'), date:'2018/03/01', value: 47.360},
{id: 'polloEntero', msFromEpoch: Date.parse('2018/04/01'), date:'2018/04/01', value: 44.750},
{id: 'polloEntero', msFromEpoch: Date.parse('2018/05/01'), date:'2018/05/01', value: 44.040},
{id: 'polloEntero', msFromEpoch: Date.parse('2018/06/01'), date:'2018/06/01', value: 46.500},
{id: 'polloEntero', msFromEpoch: Date.parse('2018/07/01'), date:'2018/07/01', value: 47.410},
{id: 'polloEntero', msFromEpoch: Date.parse('2018/08/01'), date:'2018/08/01', value: 51.580},
{id: 'polloEntero', msFromEpoch: Date.parse('2018/09/01'), date:'2018/09/01', value: 59.710},
{id: 'polloEntero', msFromEpoch: Date.parse('2018/10/01'), date:'2018/10/01', value: 61.370},
{id: 'polloEntero', msFromEpoch: Date.parse('2018/11/01'), date:'2018/11/01', value: 62.770},
{id: 'polloEntero', msFromEpoch: Date.parse('2018/12/01'), date:'2018/12/01', value: 64.280},
{id: 'polloEntero', msFromEpoch: Date.parse('2019/01/01'), date:'2019/01/01', value: 66.320},
{id: 'polloEntero', msFromEpoch: Date.parse('2019/02/01'), date:'2019/02/01', value: 72.080},
{id: 'polloEntero', msFromEpoch: Date.parse('2019/03/01'), date:'2019/03/01', value: 90.410},
{id: 'polloEntero', msFromEpoch: Date.parse('2019/04/01'), date:'2019/04/01', value: 91.780},
{id: 'polloEntero', msFromEpoch: Date.parse('2019/05/01'), date:'2019/05/01', value: 84.650},
{id: 'polloEntero', msFromEpoch: Date.parse('2019/06/01'), date:'2019/06/01', value: 84.000},
{id: 'polloEntero', msFromEpoch: Date.parse('2019/07/01'), date:'2019/07/01', value: 80.720},
{id: 'polloEntero', msFromEpoch: Date.parse('2019/08/01'), date:'2019/08/01', value: 83.880},
{id: 'polloEntero', msFromEpoch: Date.parse('2019/09/01'), date:'2019/09/01', value: 95.890},
{id: 'polloEntero', msFromEpoch: Date.parse('2019/10/01'), date:'2019/10/01', value: 98.320},
{id: 'polloEntero', msFromEpoch: Date.parse('2019/11/01'), date:'2019/11/01', value: 101.17},
{id: 'polloEntero', msFromEpoch: Date.parse('2019/12/01'), date:'2019/12/01', value: 102.48},
{id: 'polloEntero', msFromEpoch: Date.parse('2020/01/01'), date:'2020/01/01', value: 107.04},
{id: 'polloEntero', msFromEpoch: Date.parse('2020/02/01'), date:'2020/02/01', value: 108.47},
{id: 'polloEntero', msFromEpoch: Date.parse('2020/03/01'), date:'2020/03/01', value: 118.62},
{id: 'polloEntero', msFromEpoch: Date.parse('2020/04/01'), date:'2020/04/01', value: 118.37},
{id: 'polloEntero', msFromEpoch: Date.parse('2020/05/01'), date:'2020/05/01', value: 111.93},
{id: 'polloEntero', msFromEpoch: Date.parse('2020/06/01'), date:'2020/06/01', value: 111.67},
{id: 'polloEntero', msFromEpoch: Date.parse('2020/07/01'), date:'2020/07/01', value: 114.78},
{id: 'polloEntero', msFromEpoch: Date.parse('2020/08/01'), date:'2020/08/01', value: 119.25},
{id: 'polloEntero', msFromEpoch: Date.parse('2020/09/01'), date:'2020/09/01', value: 122.10},
{id: 'polloEntero', msFromEpoch: Date.parse('2020/10/01'), date:'2020/10/01', value: 132.42},
{id: 'polloEntero', msFromEpoch: Date.parse('2020/11/01'), date:'2020/11/01', value: 133.55},
{id: 'polloEntero', msFromEpoch: Date.parse('2020/12/01'), date:'2020/12/01', value: 154.99},
{id: 'polloEntero', msFromEpoch: Date.parse('2021/01/01'), date:'2021/01/01', value: 160.99},
{id: 'polloEntero', msFromEpoch: Date.parse('2021/02/01'), date:'2021/02/01', value: 168.60},
{id: 'polloEntero', msFromEpoch: Date.parse('2021/03/01'), date:'2021/03/01', value: 175.11},
{id: 'polloEntero', msFromEpoch: Date.parse('2021/04/01'), date:'2021/04/01', value: 178.41},
{id: 'polloEntero', msFromEpoch: Date.parse('2021/05/01'), date:'2021/05/01', value: 180.57},
{id: 'polloEntero', msFromEpoch: Date.parse('2021/06/01'), date:'2021/06/01', value: 190.58},
{id: 'polloEntero', msFromEpoch: Date.parse('2021/07/01'), date:'2021/07/01', value: 193.66},
{id: 'polloEntero', msFromEpoch: Date.parse('2021/08/01'), date:'2021/08/01', value: 198.66},
{id: 'polloEntero', msFromEpoch: Date.parse('2021/09/01'), date:'2021/09/01', value: 205.53},
{id: 'polloEntero', msFromEpoch: Date.parse('2021/10/01'), date:'2021/10/01', value: 208.68},
{id: 'polloEntero', msFromEpoch: Date.parse('2021/11/01'), date:'2021/11/01', value: 217.62},
{id: 'polloEntero', msFromEpoch: Date.parse('2021/12/01'), date:'2021/12/01', value: 223.64}
